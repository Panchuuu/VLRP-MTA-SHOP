                ...
                <tr key={o.id} className="border-b border-[#1e1e30]/50 hover:bg-[#13132a]">
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-slate-300 text-xs">{o.user}</span>
                    </div>
                  </td>
                  <td className="px-4 py-3 text-slate-500 text-xs">{o.items?.join(', ')}</td>
                  <td className="px-4 py-3 text-green-400 font-medium">{o.total_formatted}</td>
                  <td className="px-4 py-3">
                    <span
                  ...
                  <td className="px-4 py-3">
                    <select
                      ...
                      className="bg-[#080810] border border-[#1e1e30] text-slate-400 rounded text-xs px-2 py-1 outline-none"
                    >
